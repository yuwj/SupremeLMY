...
public class GuijMapWithLvgActivity extends BaseActivity {
    ...
    List<EntityGuijWithLvg> guijDatas;
    List<Dot> dots;
    ...
    CommonAdapter<EntityGuijWithLvg> guijAdapter;


    public static Intent createIntent(Context context, List<EntityGuijWithLvg> pathDatas, String title) {
        Intent intent = new Intent(context, GuijMapWithLvgActivity.class);
    ...
    public void initParam() {
        guijDatas = (List<EntityGuijWithLvg>) getIntent().getSerializableExtra("guijDatas");
        ...
        guijAdapter = new CommonAdapter<EntityGuijWithLvg>(context, inflatItemId, guijDatas) {
            @Override
            protected void convert(ViewHolder holder, EntityGuijWithLvg entitySearchResult, int position) {
                ...
                RatingBar ratingBar = holder.getView(R.id.rb_star);
                    ...
                    ratingBar.setRating(((EntityGuijWithLvg) entitySearchResult).getStartCount());
