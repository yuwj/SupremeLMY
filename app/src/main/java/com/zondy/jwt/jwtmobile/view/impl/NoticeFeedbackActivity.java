...
public class NoticeFeedbackActivity extends BaseActivity implements INoticeFeedbackView {
...
String tuisxxId;
    ...
    public static Intent createIntent(Context context,String tuisxxId) {
        Intent intent = new Intent(context, NoticeFeedbackActivity.class);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.tv_confirm_handle:
                ...
                noticePresenter.feedback(tuisxxId,jh,simeid,sb.toString(),feedbackStrInfo);
    ...
    public void feedbackSuccess(EntityFeedback entityFeedback) {
        ...
        intent.putExtra("entityFeedback",entityFeedback);
