...
public class ShujcjCHJGGKActivity extends BaseActivity implements View.OnClickListener {
    ...
    public int setCustomContentViewResourceId() {
        return R.layout.activity_shujcj_chjggk;
    }

    public static void actionStart(Context context) {
        Intent intent = new Intent(context, ShujcjCHJGGKActivity.class);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_commit:
                finish();
                ToastTool.getInstance().shortLength(this,"层户结构概况提交成功!",true);
                break;
        }
    }
