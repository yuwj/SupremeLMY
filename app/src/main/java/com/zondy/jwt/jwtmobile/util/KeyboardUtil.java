...
import com.zondy.jwt.jwtmobile.view.impl.MainActivity;

/**
 * Created by sheep on 2017/3/20.
 */
...
//    private int currentEditText = 0;//默认当前光标在第一个EditText
    public KeyboardUtil(Context ctx1,View view, TextView textView,PopupWindow popupWindow) {
        this.ctx = ctx1;
//        this.edits = edits;
...
//                , "Z", "X", "C", "V", "B", "N", "M"};
    ...
    private KeyboardView.OnKeyboardActionListener listener = new KeyboardView.OnKeyboardActionListener() {
        ...
        public void onKey(int primaryCode, int[] keyCodes) {
            if(primaryCode!=888&&primaryCode!=999){
